...
<table style="width:99%">
    ...
    <td width="33%">
    <a class="body" href="https://www.overleaf.com/read/bxgjqbzmvwhn" target="_blank">Simplex Method</a> - matrix operations and implementation<br>
    </td>
    <td width="33%">
    Continue <a class="body" href="https://www.overleaf.com/read/msnkstspwqdm" target="_blank">Blondie24 Project</a><br>
    </td> 
    ...
    <td width="33%">
    Neural net regressor with multiple hidden layers<br>
    EXAM NEXT FRIDAY! (2/25)
    </td>
    <td width="33%">
    ...
    <td width="33%">
    Space Empires - economic phase strategy development + competition  
    </td>
    <td width="33%">
    Mini kaggle competition (on a toy dataset generated by the instructor)
    </td> 
    </tr>
    <tr>
    <td width="33%">
