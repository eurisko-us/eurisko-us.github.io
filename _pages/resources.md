...
<div style="width:100%; max-width:800px; margin:auto"> 
<br>On each assignment, you will make a GitHub issue on another student's machine-learning, simulation, graph, or space-empires repository (NOT the assignment-problems repository), and you will resolve an issue that another student has made on your own repository. To find the student whose code you are supposed to review, add your class-student number to the assignment number, modulo the number of students in your class.<br><br>
